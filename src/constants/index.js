...
const organizationActions = {
  ...
  MsgActionOrganizationGetAllProjectInOrganization:
    'ORGANIZATION_GET_ALL_PROJECT_IN_ORGANIZATION',
  MsgActionOrganizationGetAllProjectNotOnOrganization:
    'ORGANIZATION_GET_ALL_PROJECT_NOT_ON_ORGANIZATION',
  MsgActionOrganizationAddProjectsToOrganization:
    'ORGANIZATION_ADD_PROJECTS_TO_ORGANIZATION',
  MsgActionOrganizationRemoveProjectsToOrganization:
    'ORGANIZATION_REMOVE_PROJECTS_TO_ORGANIZATION'
};
