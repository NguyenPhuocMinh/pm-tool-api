...
var logger = (0, _logger["default"])(_constants["default"].APP_NAME, _constants["default"].STRUCT_ADAPTERS.SOCKET_ADAPTER);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            io.use(_middleware.socketMiddleware);
            io.on('connection', function (socket) {
              ...
              socket.on(SOCKET_USER_LOGOUT, /*#__PURE__*/function () {
                  ...
                  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          _context2.next = 2;
                          return _workers["default"].handlerSocketWorkerUserLogout(data, {
                            socket: socket,
                            io: io
                          });
                        case 2:
