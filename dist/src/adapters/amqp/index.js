...
var logger = (0, _logger["default"])(_constants["default"].APP_NAME, _constants["default"].STRUCT_ADAPTERS.AMQP_ADAPTER);
var APP_RABBIT_URI = _conf.profiles.APP_RABBIT_URI;
var conn = null;
var channel = null;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _amqplib["default"].connect(APP_RABBIT_URI + '?heartbeat=60');
          case 3:
            conn = _context.sent;
            _context.next = 6;
