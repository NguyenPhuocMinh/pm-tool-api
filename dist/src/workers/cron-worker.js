...
var logger = (0, _logger["default"])(_constants["default"].APP_NAME, _constants["default"].STRUCT_WORKER.CRON_WORKER);
var handlerWorkerCronChangePasswordTemporary = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(now) {
    var overDay, users, userIds, newHashPass, dataUpdate;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            logger.log({
              ...
              message: 'Function handlerWorkerCronChangePasswordTemporary has been start',
              args: {
                now: now
              }
            });
             ...
             * createdAt < now - 1
             */
            overDay = (0, _moment["default"])(now).add(7, 'hours').tz(_constants["default"].TIMEZONE_DEFAULT).utc().subtract(1, 'day').format();
            _context.next = 5;
