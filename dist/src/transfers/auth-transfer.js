...
var loggerFactory = (0, _logger["default"])(_constants["default"].APP_NAME, _constants["default"].STRUCT_TRANSFERS.AUTH_TRANSFER);
var authTransfer = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            data = data.toJSON();
            _data = data, _id = _data._id, firstName = _data.firstName, lastName = _data.lastName, email = _data.email, isAdmin = _data.isAdmin, roles = _data.roles, locale = _data.locale, picture = _data.picture, isPasswordTemporary = _data.isPasswordTemporary;
            _context.next = 8;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            roles = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : [];
            _context2.prev = 1;
            permissions = _repository["default"].findAll({
              type: 'PermissionModel',
              filter: {
                roles: {
                  $in: roles === null || roles === void 0 ? void 0 : roles.map(function (r) {
                    return r._id;
                  })
                }
              },
...
var convertMap = function convertMap() {
  var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  var dataMap = (0, _lodash.map)(data, function (e) {
    return e.name;
  });
  return dataMap;
};
var _default = authTransfer;
