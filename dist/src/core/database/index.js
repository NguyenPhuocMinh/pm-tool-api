      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _mongoose["default"].connect(APP_MONGO_URI, _conf.options.mongooseOptions);
          case 3:
            secret = _helpers["default"].getDataJsonHelper();
            _secret$admin = secret.admin, email = _secret$admin.email, password = _secret$admin.password; // check admin exists
            _context.next = 7;
          ...
          case 7:
            ...
            break;
          case 12:
            hashPass = _bcrypt["default"].hashSync(password, _conf.options.bcryptOptions.salt);
            data = {
              email: email,
              password: hashPass,
              firstName: 'Admin',
            ...
            data = _helpers["default"].attributeHelper(null, data, 'create');
            _context.next = 17;
