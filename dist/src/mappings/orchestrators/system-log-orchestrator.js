...
var loggerFactory = (0, _logger["default"])(_constants["default"].APP_NAME, _constants["default"].STRUCT_ORCHESTRATORS.SYSTEM_LOG_ORCHESTRATOR);
var APP_VERCEL_TOKEN = _conf.profiles.APP_VERCEL_TOKEN;

/**
 * @description Get All System Log Orchestrator
 * @param {*} toolBox { req, res, next }
 */
var getAllSystemLog = /*#__PURE__*/function () {
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _nodeFetch["default"])('https://api.vercel.com/v1/integrations/log-drains', {
              method: 'GET',
              headers: {
                Authorization: "Bearer ".concat(APP_VERCEL_TOKEN)
              }
            }).then(function (res) {
              return res.json();
            });
...
var systemLogOrchestrator = {
  getAllSystemLog: getAllSystemLog
};
var _default = systemLogOrchestrator;
