...
var logger = (0, _logger["default"])(_constants["default"].APP_NAME, _constants["default"].STRUCT_ORCHESTRATORS.TEST_ORCHESTRATOR);

/**
 * @description Test Send Queue Orchestrator
 * @param {*} toolBox { req, res, next }
 */
var testSendQueue = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(toolBox) {
    var req, requestId, dataTest;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return _amqp["default"].publisher(_constants["default"].AMQP_QUEUES.TEST_QUEUE, _constants["default"].types.MsgTypeTest, requestId, dataTest);
          case 7:
            logger.log({
              level: _constants["default"].LOG_LEVELS.INFO,
  ...
  return function testSendQueue(_x) {
