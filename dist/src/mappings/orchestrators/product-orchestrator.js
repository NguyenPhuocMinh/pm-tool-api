...
var logger = (0, _logger["default"])(_constants["default"].APP_NAME, _constants["default"].STRUCT_ORCHESTRATORS.PRODUCT_ORCHESTRATOR);
...
var getAllProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(toolBox) {
    var req, _helpers$paginationHe, skip, limit, query, sort, products, total, response;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 11:
            total = _context.sent;
            _context.next = 14;
            return _bluebird["default"].map(products, function (data) {
              data = data.toJSON();
              var _data = data,
                _id = _data._id,
...
var createProduct = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(toolBox) {
    var req, error, name, slug, isDuplicate, product, data, result;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            // validate inputs
            error = _validators["default"].validatorProduct(req.body);
            if (!error) {
              _context2.next = 6;
              break;
            }
            throw _commons["default"].newError('productE001');
          case 6:
            name = req.body.name;
            slug = _helpers["default"].slugHelper(name); // check duplicate slug
            _context2.next = 10;
            return _helpers["default"].duplicateHelper('ProductModel', {
              slug: slug
            });
          case 10:
            ...
            throw _commons["default"].newError('productE002');
          case 13:
            product = (0, _lodash.assign)(req.body, {
              slug: slug
            });
            product = _helpers["default"].attributeHelper(req, product, 'create');
            _context2.next = 17;
          ...
          case 17:
            data = _context2.sent;
            result = _transfers["default"].productTransfer(data);
            logger.log({
              level: _constants["default"].LOG_LEVELS.INFO,
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 6:
            ...
            result = _transfers["default"].productTransfer(product);
            logger.log({
              level: _constants["default"].LOG_LEVELS.INFO,
...
var updateProduct = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(toolBox) {
    var req, id, product, error, name, slug, isDuplicate, _req$body, image, description, price, discount, category, activated, updatedAt, updatedBy, result;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 17:
            ...
            _req$body = req.body, image = _req$body.image, description = _req$body.description, price = _req$body.price, discount = _req$body.discount, category = _req$body.category, activated = _req$body.activated, updatedAt = _req$body.updatedAt, updatedBy = _req$body.updatedBy;
            product.name = name;
            product.image = image;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            throw _commons["default"].newError('productE003');
          case 6:
            req.body = _helpers["default"].attributeHelper(req, req.body);
            _context5.next = 9;
 ...
 * @param {*} id
 */
var getProductFunc = /*#__PURE__*/function () {
  ...
  return function getProductFunc(_x6) {
    return _ref6.apply(this, arguments);
  };
}();
var productOrchestrator = {
...
var _default = productOrchestrator;
