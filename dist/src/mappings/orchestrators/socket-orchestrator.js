...
var logger = (0, _logger["default"])(_constants["default"].APP_NAME, _constants["default"].STRUCT_ORCHESTRATORS.SOCKET_ORCHESTRATOR);

/**
 * @description Get Socket Orchestrator
 * @param {*} toolBox { req, res, next }
 */
var getSocket = /*#__PURE__*/function () {
 ...
 * @param {*} toolBox { req, res, next }
 */
var postSocket = /*#__PURE__*/function () {
  ...
  return function postSocket(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
var socketOrchestrator = {
  getSocket: getSocket,
  postSocket: postSocket
};
var _default = socketOrchestrator;
