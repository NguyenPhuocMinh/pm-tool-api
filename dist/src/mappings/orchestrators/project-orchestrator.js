...
var loggerFactory = (0, _logger["default"])(_constants["default"].APP_NAME, _constants["default"].STRUCT_ORCHESTRATORS.PROJECT_ORCHESTRATOR);
...
var getAllProject = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(toolBox) {
    var req, _helpers$paginationHe, skip, limit, query, sort, projects, total, response;
...
var createProject = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(toolBox) {
    var req, error, name, slug, isDuplicate, doc, data, result;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            // validate inputs
            error = _validators["default"].validatorProject(req.body);
            if (!error) {
              _context2.next = 6;
              break;
            }
          ...
          case 13:
            ...
            doc = _helpers["default"].attributeHelper(null, doc, 'create');
            _context2.next = 17;
