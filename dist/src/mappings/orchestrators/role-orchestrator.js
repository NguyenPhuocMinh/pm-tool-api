...
var loggerFactory = (0, _logger["default"])(_constants["default"].APP_NAME, _constants["default"].STRUCT_ORCHESTRATORS.ROLE_ORCHESTRATOR);
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            req = toolBox.req;
            _context7.prev = 1;
            loggerFactory.info("Function getPermissionsByRoleID Orchestrator has been start");
            id = req.params.id;
            if (!(0, _lodash.isEmpty)(id)) {
              _context7.next = 6;
              break;
          ...
          case 17:
            ...
            loggerFactory.info("Function getPermissionsByRoleID Orchestrator has been end");
