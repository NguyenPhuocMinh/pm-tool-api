...
var loggerFactory = (0, _logger["default"])(_constants["default"].APP_NAME, _constants["default"].STRUCT_ORCHESTRATORS.USER_SESSION_ORCHESTRATOR);

/**
 * @description Get All User Session Orchestrator
 * @param {*} toolBox { req, res, next }
 */
var getUserTimelineSession = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(toolBox) {
    var req, userID, _helpers$paginationHe, skip, limit, query, sort, timelines, total, response;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 12:
            total = _context.sent;
            _context.next = 15;
            return _commons["default"].dataResponsesMapper(timelines);
          case 15:
  ...
  return function getUserTimelineSession(_x) {
...
var createUserSession = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            data = _helpers["default"].attributeHelper(req, {
              user: userID,
          ...
          case 9:
            ...
            data = _transfers["default"].userSessionTransfer(userSession);
  ...
  return function createUserSession(_x2) {
 ...
 * @param {*} toolBox { req, res, next }
 */
var updateUserSession = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(toolBox, records) {
    var req, id, reason, userSession, data;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 6:
            userSession = _context3.sent;
            data = _helpers["default"].attributeHelper(req, userSession);
  ...
  return function updateUserSession(_x3, _x4) {
...
var deleteUserSession = /*#__PURE__*/function () {
  ...
  return function deleteUserSession(_x5) {
 ...
 * @param {*} id
 */
var getUserSession = /*#__PURE__*/function () {
