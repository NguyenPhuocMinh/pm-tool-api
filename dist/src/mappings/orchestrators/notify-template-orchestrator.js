...
var loggerFactory = (0, _logger["default"])(_constants["default"].APP_NAME, _constants["default"].STRUCT_ORCHESTRATORS.NOTIFY_TEMPLATE_ORCHESTRATOR);

/**
 * @description Get All Notify Template Orchestrator
 * @param {*} toolBox { req, res, next }
 */
var getAllNotifyTemplate = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(toolBox) {
    var req, _helpers$paginationHe, skip, limit, query, sort, notifyTemplates, total, data;
  ...
  return function getAllNotifyTemplate(_x) {
...
var createNotifyTemplate = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            slug = _helpers["default"].slugHelper(topic);
            _context2.next = 11;
  ...
  return function createNotifyTemplate(_x2) {
