 ...
 */
var getAllUserOnline = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(toolBox) {
    var req, _helpers$paginationHe, skip, limit, query, sort, usersOnline, total, response;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 11:
            total = _context.sent;
            _context.next = 14;
            return _bluebird["default"].map(usersOnline, function (data) {
              loggerFactory.data("Function dataResponsesMapper has been end");
              return _transfers["default"].userOnlineTransfer(data, req);
            }, {
              concurrency: 5
            });
          case 14:
  ...
  return function getAllUserOnline(_x) {
    return _ref.apply(this, arguments);
  };
}();
var userOnlineOrchestrator = {
  getAllUserOnline: getAllUserOnline
};
var _default = userOnlineOrchestrator;
