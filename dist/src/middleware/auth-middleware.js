...
var _authorization = require("../policies/authorization");
...
var loggerFactory = (0, _logger["default"])(_constants["default"].APP_NAME, _constants["default"].STRUCT_MIDDLEWARE.AUTH_MIDDLEWARE);
...
var authMiddleware = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
    var route, method, toolBox, findPublicAuth, enablePublicAuth, findPrivateAuth, enablePrivateAuth, token, tokenNotFoundError, _helpers$getSecretJso, publicSecret;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            route = req.route, method = req.method;
            toolBox = {
              req: req,
              res: res,
              next: next
            ...
            findPublicAuth = (0, _lodash.find)(_authorization.publicAuthorization, function (item) {
              return item.pathName === route.path && item.method === (0, _lodash.toUpper)(method);
            });
            enablePublicAuth = (0, _lodash.get)(findPublicAuth, 'enable');
            findPrivateAuth = (0, _lodash.find)(_authorization.privateAuthorization, function (item) {
              return item.pathName === route.path && item.method === (0, _lodash.toUpper)(method);
            });
            enablePrivateAuth = (0, _lodash.get)(findPrivateAuth, 'enable');
            _context2.prev = 7;
             ...
             */
            if (!(!(0, _lodash.isEmpty)(findPublicAuth) && !enablePublicAuth)) {
              _context2.next = 12;
              break;
            }
          ...
          case 12:
             ...
             * Verify token
             */
            token = req.header(ATTRIBUTE_TOKEN_KEY) || req.cookies[ATTRIBUTE_TOKEN_KEY] || req.session[ATTRIBUTE_TOKEN_KEY];
          ...
          case 18:
            ...
            _jsonwebtoken["default"].verify(token, publicSecret, /*#__PURE__*/function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(err, decoded) {
                var tokenError, blacklistToken, tokenBlackListError, id, iat, exp, userIsAdmin, userPermissions, tokenForbiddenError;
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        loggerFactory.error("Function authMiddleware verify token has been error", {
                      ...
                      case 9:
                        return _context.abrupt("break", 10);
                      case 10:
                        return _context.abrupt("return", _builds["default"].errorResponse(toolBox, tokenError));
                      case 13:
                        _context.next = 15;
                      ...
                      case 20:
                         ...
                         */
                        userIsAdmin = (0, _lodash.get)(decoded, 'isAdmin');
                        if (!userIsAdmin) {
                          _context.next = 27;
                          break;
                        }
                        loggerFactory.verbose("Function authMiddleware has been end with message", {
                          args: {
                      ...
                      case 27:
                        ...
                        return _context.abrupt("return", next());
                      case 30:
                        if (!(!(0, _lodash.isEmpty)(findPrivateAuth) && !enablePrivateAuth)) {
                          _context.next = 33;
                          break;
                        }
                        loggerFactory.verbose("Function authMiddleware has been end with message", {
                          args: {
                            message: 'No need verify permissions if find private paths and enable private path is false'
                          }
                        });
                        return _context.abrupt("return", next());
                      case 33:
                         ...
                         */
                        userPermissions = (0, _lodash.get)(decoded, 'permissions');
                        _context.prev = 34;
                        if (!(0, _lodash.includes)(userPermissions, findPrivateAuth.permission)) {
                          _context.next = 40;
                          break;
                        }
                        loggerFactory.verbose("Function authMiddleware has been end with message", {
                      ...
                      case 45:
                        ...
                        loggerFactory.error("Function authMiddleware has been error", {
                          args: _utils["default"].formatErrorMsg(_context.t1)
                        });
