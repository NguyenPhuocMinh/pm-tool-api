...
var loggerFactory = (0, _logger["default"])(_constants["default"].APP_NAME, _constants["default"].STRUCT_NAME_SERVER);
...
var io = new _socket2.Server(server, {
  cors: {
    origin: '*'
  }
});
