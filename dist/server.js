...
var _logger = _interopRequireDefault(require("./src/core/logger"));
...
var logger = (0, _logger["default"])(_constants["default"].APP_NAME, _constants["default"].STRUCT_NAME_SERVER);
var APP_PORT = _conf.profiles.APP_PORT;
var APP_HOST = _conf.profiles.APP_HOST;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            app.use((0, _cors["default"])({
              origin: ['https://pm-tool-ui.netlify.app', 'https://pm-tool-ui.netlify.app/', 'https://pm-tool-ui.netlify.app/*']
            }));
             ...
             * Docs
             */
            swaggerYaml = _yamljs["default"].load(_path["default"].resolve(__dirname, '../src/docs', 'swagger.yaml'));
            app.use(APP_DOCS_PATH, _swaggerUiExpress["default"].serve, _swaggerUiExpress["default"].setup(swaggerYaml));
            logger.log({
             ...
             * Error handler
             */
            app.use(_middleware.errorMiddleware);
          ...
          case 18:
            ...
            server.listen(APP_PORT, APP_HOST, function () {
              ...
              logger.log({
                level: _constants["default"].LOG_LEVELS.HTTP,
